...
<script>
    ...
    const items = [
      ...
      },
      {
        ...
        description: 'Schedule a consultation with our experts to discuss how we can elevate your business with custom software solutions.',
  ...
  <style>
    ...
    @media (max-width: 1024px) {
      ...
      .item-5 { grid-column: 1 / 3; grid-row: 4 / 5; }
    }
